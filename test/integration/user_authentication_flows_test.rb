...
class UserAuthenticationFlowsTest < ActionDispatch::IntegrationTest
  ...
  test "successful registration" do
    ...
    # After submitting the form, redirect to root
    assert_equal root_path, current_path
    # And a message should say "Account Created"
    assert page.has_content?("Account created")
    # And the nav should no longer have a link to Sign Up, but a link to Logout
